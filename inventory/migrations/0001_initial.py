# Generated by Django 3.2.12 on 2022-03-19 04:58
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.TextField(blank=True, db_column='nombre', max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(db_column='description', max_length=1000, unique=True)),
                ('state', models.BooleanField(db_column='estado', default=True)),
            ],
            options={
                'db_table': 'inv_item',
